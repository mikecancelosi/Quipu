<template>
  <q-header elevated>
    <q-toolbar class="headingContainer">
      ...
      <div class="row" style="align-items: center">
        <q-btn
          ...
          dense
          flat
          style="margin-right: 15px; padding: 0px"
        />
    ...
    <q-tabs dense style="position: absolute; bottom: 0">
      ...
      <q-tab disable> Board </q-tab>

      <q-tab disable> Timeline </q-tab>

      <q-tab disable> Calendar </q-tab>

      <q-tab disable> Dashboard </q-tab>

      <q-tab disable> Messages </q-tab>

      <q-tab disable> Files </q-tab>
    </q-tabs>
  </q-header>
...
export default {
  ...
  methods: {
    getTeam() {
      axios
        .get("http://127.0.0.1:5000/api/Teams/" + this.id)
        .then((response) => {
