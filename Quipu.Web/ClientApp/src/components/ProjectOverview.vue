    ...
    <q-layout>
        <q-drawer v-model="rightDrawerOpen" side="right" bordered :width="400">
            <div class="q-drawer-container">
                ...
                <div class="row">
                    <q-btn no-caps outline dense>
                        <q-avatar color="green-5" rounded size="10px" style="margin-right:10px" />
                        <div>On track</div>
                    </q-btn>

                    <q-btn no-caps outline>
                        <q-avatar color="amber-5" rounded size="10px" style="margin-right:10px" />
                        <div>At risk</div>
                    </q-btn>

                    <q-btn no-caps outline>
                        <q-avatar color="red-5" rounded size="10px" style="margin-right:10px" />
                        <div>Off track</div>
                    </q-btn>
                </div>
            </div>
