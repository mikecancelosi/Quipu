...
namespace Quipu.Core.Migrations
{
    ...
    [Migration("20211026175942_AddUserRefToTaskRevisions")]
    partial class AddUserRefToTaskRevisions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quipu.Core.DomainModel.DiscussionOwner", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Quipu.Core.DomainModel.Task", b =>
                {
                    ...
                    b.Property<int?>("DiscussionOwnerID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Quipu.Core.DomainModel.TaskRevision", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Quipu.Core.DomainModel.TaskStatusCategory", b =>
                {
                    ...
                    b.ToTable("TaskStatusCategories");
                });
            ...
            modelBuilder.Entity("Quipu.Core.DomainModel.Discussion", b =>
                {
                    b.HasOne("Quipu.Core.DomainModel.DiscussionOwner", "Owner")
            ...
            modelBuilder.Entity("Quipu.Core.DomainModel.Task", b =>
                {
                    ...
                    b.HasOne("Quipu.Core.DomainModel.DiscussionOwner", "DiscussionOwner")
                        .WithMany()
                        .HasForeignKey("DiscussionOwnerID");
            ...
            modelBuilder.Entity("Quipu.Core.DomainModel.TaskRevision", b =>
                {
                    b.HasOne("Quipu.Core.DomainModel.Task", "Task")
                        .WithMany("Revisions")
                        .HasForeignKey("TaskID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
